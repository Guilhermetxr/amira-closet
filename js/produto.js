...
async function iniciar() {
  ...
  $("#detalhe").innerHTML = `
    ...
    <div class="prod__col--info">
      ${cat ? `<span class="prod__tag">${esc(cat.nome)}${produto.selo && SELOS[produto.selo] ? " · " + esc(SELOS[produto.selo]) : ""}</span>` : ""}
