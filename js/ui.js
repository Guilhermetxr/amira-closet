...
import { dados, MODO_DEMO, SELOS } from "./db.js";
...
export const ico = {
  ...
  /* categorias de moda (traço fino, mesmo estilo dos demais) */
  vestido: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2.5v4c0 1.5-1 2.7-2.2 3.4L4.5 21.5h15L17.2 9.9C16 9.2 15 8 15 6.5v-4"/><path d="M7 10h10"/></svg>`,
  blusa: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M8.5 3 3 6l2 4.2 2-.9V21h10V9.3l2 .9L21 6l-5.5-3c-.5 1.6-1.9 2.6-3.5 2.6S9 4.6 8.5 3Z"/></svg>`,
  short: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M5 4h14l1.2 15h-6.3L12 12.5 10.1 19H3.8L5 4Z"/><path d="M5 7.5h14"/></svg>`,
  calca: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M7 2.5h10l1.4 19h-5.1L12 9.5l-1.3 12H5.6L7 2.5Z"/><path d="M7 6h10"/></svg>`,
  conjunto: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M7 3v4.5a4.5 4.5 0 0 0 4.5 4.5M17 3v4.5a4.5 4.5 0 0 1-4.5 4.5M11.5 12h1"/><path d="M6.5 15.5h11l-3 4.5c-.6.9-1.6 1-2.5 1s-1.9-.1-2.5-1l-3-4.5Z"/></svg>`,
  cabide: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 9.5V8a2.2 2.2 0 1 0-2.2-2.2"/><path d="m12 9.5-8.7 6.2c-.9.7-.4 2.1.7 2.1h16c1.1 0 1.6-1.4.7-2.1L12 9.5Z"/></svg>`,
    ...
    <article class="card">
      <div class="card__top">
        <a class="card__media" href="produto.html?id=${esc(p.id)}" aria-label="${esc(p.nome)}">
          ...
          ${p.selo && SELOS[p.selo] ? `<div class="card__selo">${esc(SELOS[p.selo])}</div>` : ""}
  ...
  document.body.insertAdjacentHTML(
    ...
    <header class="hdr">
      <div class="wrap hdr__in">
        ...
        <a class="hdr__logo" href="index.html">
          <span class="hdr__mark"><img src="img/sol.png" alt=""></span>
    ...
    <div class="searchbar" id="barraBusca">
      <form class="wrap" action="categoria.html" method="get">
        <input type="search" name="q" placeholder="Buscar vestido, blusa, short..." aria-label="Buscar" autocomplete="off">
...
export const perks = `
  <div class="perks">
    <div class="perk">${ico.caminhao}<b>Entregas</b><span>Prazo e frete combinados no zap</span></div>
    <div class="perk">${ico.pix}<b>Pagamento facilitado</b><span>Pix e cartão no atendimento</span></div>
    <div class="perk">${ico.medalha}<b>Leve &amp; confortável</b><span>Peças escolhidas com carinho</span></div>
    <div class="perk">${ico.escudo}<b>Atendimento humano</b><span>Tire dúvidas de tamanho no zap</span></div>
  </div>`;
