...
/* tamanhos oferecidos por padrão no formulário (letras e numeração) */
const TAMANHOS_SUGERIDOS = ["Único", "PP", "P", "M", "G", "GG", "36", "38", "40", "42", "44", "46"];
  ...
  $("#listaCategorias").innerHTML = st.categorias.length
    ? st.categorias
      ...
      <div class="item">
        ...
        .join("")
    : `<div class="vazio">Nenhuma categoria ainda. Crie a primeira (ex.: Vestidos, Blusas, Shorts).</div>`;
