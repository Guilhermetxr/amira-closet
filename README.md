# Catálogo de Moda — Amira Closet

Catálogo digital para a Amira Closet (@amiracloset), loja de moda feminina
(vestidos, blusas, shorts, calças, conjuntos e acessórios). O cliente navega por seções,
...
A senha do painel nesse modo é a que está em `DEMO_SENHA` (padrão: `amira123`).
...
do nome; a consulta usa `array-contains`. Resolve bem o caso real ("vestido",
"floral", "short") sem depender de serviço externo de busca.
